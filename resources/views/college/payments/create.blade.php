...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('college.payments.store') }}" method="POST">
                @csrf
                ...
                <div class="alert alert-info">
                    ...
                    Payment records created by college users must be verified by administrators. Initially, all payments will have a "Pending" status.
                </div>
                ...
                <div class="row">
                    <div class="col-md-9 offset-md-3">
                        ...
                        <a href="{{ route('college.payments.index') }}" class="btn btn-outline-secondary ms-2">
