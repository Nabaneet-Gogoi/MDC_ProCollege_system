...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <i class="bi bi-pencil me-1"></i> Edit College Information
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('state') is-invalid @enderror" id="state" name="state" value="{{ old('state', $college->state) }}" required>
                            @error('state')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('district') is-invalid @enderror" id="district" name="district" value="{{ old('district', $college->district) }}" required>
                            @error('district')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" id="phaseContainer" style="{{ $college->type === 'professional' ? 'display: none;' : '' }}">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('phase') is-invalid @enderror" id="phase" name="phase" {{ $college->type === 'MDC' ? 'required' : '' }}>
