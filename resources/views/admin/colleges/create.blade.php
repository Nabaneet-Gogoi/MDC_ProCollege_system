...
@section('content')
    ...
    <div class="modern-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <h1><i class="bi bi-plus-circle me-2"></i>Add New College</h1>
        ...
        <div class="modern-card-body">
            <form action="{{ route('admin.colleges.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control modern-form-control @error('college_name') is-invalid @enderror" id="college_name" name="college_name" value="{{ old('college_name') }}" required>
                    @error('college_name')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control modern-form-control @error('state') is-invalid @enderror" id="state" name="state" value="{{ old('state') }}" required>
                            @error('state')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control modern-form-control @error('district') is-invalid @enderror" id="district" name="district" value="{{ old('district') }}" required>
                            @error('district')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" id="phaseContainer" style="{{ old('type') === 'professional' ? 'display: none;' : '' }}">
                        <div class="mb-3">
                            ...
                            <select class="form-select modern-form-select @error('phase') is-invalid @enderror" id="phase" name="phase" {{ old('type') === 'professional' ? '' : 'required' }}>
